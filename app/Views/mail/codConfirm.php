...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="force-row" style="width: 600px;">
  ...
  <tr>
    <td class="content-wrapper" style="font-family:Segoe UI, Helvetica, Arial, sans-serif;padding-left:24px;padding-right:24px;text-align: left;">
      <p style="text-transform:uppercase;font-size: 24px !important;margin-top: 15px; margin-bottom: 15px;">Confirmação de cadastro</p> 
      ...
      */ ?>
      ...
      <h3>Quase pronto!</h3>
      <p>Olá <?= $name ?>!</p>
      <p>Para continuar seu cadastro, é necessário confirmação do código de verificação.</p>
      <!-- <p>Seu código de verificação é:</p> -->
      <h2 id="Codigo"><?= $code ?></h2>
      <p>Digite esse código para ativar sua conta.</p>

      <!-- Clique aqui para acessarClick here [open code in app] to open the [app/portal landing page]. -->
